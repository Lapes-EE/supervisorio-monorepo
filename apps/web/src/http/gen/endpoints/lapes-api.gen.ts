...
export const patchMeterId = (
 ...
 signal?: AbortSignal
      ...
      {url: `/meter/${id}`, method: 'PATCH', signal
    },
      );
    }
...
export const getPatchMeterIdMutationOptions = <TError = void | PatchMeterId401,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchMeterId>>, TError,{id: number}, TContext>, }
...
export const getTelemetryIp = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<GetTelemetryIp200>(
      {url: `/telemetry/${ip}`, method: 'GET', signal
    },
      );
    }
...
export const getGetTelemetryIpQueryOptions = <TData = Awaited<ReturnType<typeof getTelemetryIp>>, TError = unknown>(ip: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTelemetryIp>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTelemetryIpQueryKey(ip);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTelemetryIp>>> = ({ signal }) => getTelemetryIp(ip, signal);
...
export type GetTelemetryIpQueryError = unknown


export function useGetTelemetryIp<TData = Awaited<ReturnType<typeof getTelemetryIp>>, TError = unknown>(
...
export function useGetTelemetryIp<TData = Awaited<ReturnType<typeof getTelemetryIp>>, TError = unknown>(
 ip: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTelemetryIp>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get raw data from external API
