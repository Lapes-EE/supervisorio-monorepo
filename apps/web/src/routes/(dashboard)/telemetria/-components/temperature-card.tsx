    ...
    <Card>
      ...
      <CardContent className="flex items-center justify-between pt-4">
        ...
        <div className="relative flex h-40 w-10 flex-col items-center justify-end">
          {/* Bulbo do termômetro */}
          <div className="absolute bottom-0 z-50 h-6 w-6 rounded-full bg-linear-to-t from-red-600 via-orange-400 to-yellow-300 shadow-md" />

          {/* Corpo do termômetro */}
          <div className="relative z-10 h-full w-4 overflow-hidden rounded-full border bg-gray-200 shadow-inner">
            <div
              className="absolute bottom-0 w-full rounded-t-full bg-linear-to-t from-red-600 via-orange-400 to-yellow-300 transition-all duration-500"
